...
module.exports = ({
    ...
    resolve,
    options: {
        eslint: { lintOnSave = false, extensions },
    },
    api,
}) => {
    const path = require('path');
    const eslintOptionsPath = resolve('packages', 'eslint', 'eslintOptions');
    ...
    return () => {
        ...
        const eslintPkg =
            loadModule('eslint/package.json', cwd, true) || loadModule('eslint/package.json', __dirname, true);
